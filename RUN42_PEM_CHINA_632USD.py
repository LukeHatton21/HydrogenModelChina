...
output_folder = shared_folder_path + "/V6_CHINA_OUTPUT/PEM/"
...
elec_tech = "PEM"       # Set to either PEM or Alkaline
optimisation = "True"   # Set to "True" (included only for debugging)
elec_capex = 632        # Set to specified electrolyser CAPEX (1200 USD/kW for Alkaline, 1400 USD/kW for PEM)
num_cores = 128           # Set to number of cores to use for each Hydrogen Model case
